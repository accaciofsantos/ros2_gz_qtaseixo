...
def generate_launch_description():
    #world_path = os.path.expanduser('~/ros2_ws/src/ros2_gz_qtaseixo/worlds/scenario_solo_firm.world')
    #world_path = os.path.expanduser('~/ros2_ws/src/ros2_gz_qtaseixo/worlds/scenario_solo_medium.world')
    world_path = os.path.expanduser('~/ros2_ws/src/ros2_gz_qtaseixo/worlds/scenario_solo_slippery.world')
