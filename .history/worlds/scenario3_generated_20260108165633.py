...
yaw_col4 = math.radians(10.0)   # 10° rotação da 4ª coluna
...
# Pivô para rotacionar toda a 4ª coluna
pivot_col4_x = 3 * dx  # coluna index 3 (4ª coluna)
pivot_col4_y = 0       # primeira árvore da coluna (linha 0)
