...
yaw_col4 = math.radians(-45.0)   # 10° rotação da 4ª coluna
jitter_x = 0.0                 # deslocamento aleatório ±0.20m nas colunas 2 e 3
jitter_y = 0.0                 # deslocamento aleatório ±0.25m nas colunas 2 e 3

tree_includes = ""
tree_id = 1

# Pivô para rotacionar toda a 4ª coluna (primeira árvore da coluna)
pivot_col4_x = 3 * dx
pivot_col4_y = 0
...
for row in range(num_rows):
    ...
    for col in range(num_cols):
        ...
        # === 4ª coluna: rotaciona toda a fileira em torno do pivô ===
        elif col == 3:
            x2 = pivot_col4_x + (x - pivot_col4_x)*math.cos(yaw_col4) - (y - pivot_col4_y)*math.sin(yaw_col4)
            y2 = pivot_col4_y + (x - pivot_col4_x)*math.sin(yaw_col4) + (y - pivot_col4_y)*math.cos(yaw_col4)
        ...
        # fallback para outras colunas (5ª, 6ª)
        else:
            x2, y2, yaw = x, y, 0.0
