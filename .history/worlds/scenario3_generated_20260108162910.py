...
world_filename = "scenario3_inverted.world"
world_path = os.path.join(world_folder, world_filename)

# === Parâmetros do desalinhamento ===
yaw_col4 = math.radians(5.0)   # 5 graus de inclinação global na 4ª coluna
jitter_x = 0.20                # jitter ±0.20m nas colunas 2 e 3
jitter_y = 0.25                # jitter ±0.25m nas colunas 2 e 3
...
# === HEADER (igual ao scenario2) ===
world_header = """<?xml version='1.0'?>
<sdf version='1.6'>
  <world name='scenario3_inverted'>
...
print(f"[OK] scenario3_inverted gerado em {world_path}")
