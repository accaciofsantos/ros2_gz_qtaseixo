...
class UGVController(Node):
    ...
    def control_loop(self):
        ...
        angle_err = self.shortest_angle(angle_to_goal, self.yaw)  # <<< usa menor rotação
        ...
        # --------------------------
        if abs(angle_err) > math.pi/6:  # 30 graus
            v_cmd *= 0.5
    ...
    def pd_controller_with_observer(self, dist, angle_err):
        ...
        angle_err_hat = self.shortest_angle(angle_to_goal_hat, yaw_hat)
