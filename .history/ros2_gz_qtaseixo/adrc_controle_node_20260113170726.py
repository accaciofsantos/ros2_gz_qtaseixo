...
class UGVController(Node):
    def __init__(self):
        ...
        self.csv_fields = [
            ...
            'eso_ang_x1', 'eso_ang_x2', 'eso_ang_x3'      # ESO angular 3ª ordem
        ]
    ...
    def define_goals(self, pattern):
        if pattern == "quadrado":
            ...
            return [(4.0, -2.0), (8.0, 2.0), (12.0, -2.0)]
    ...
    def control_loop(self):
        ...
        self.x_ref = goal_x
        self.y_ref = goal_y
        self.yaw_ref = math.atan2(goal_y - self.position[1], goal_x - self.position[0])

        # --- erros ---
        dx = goal_x - self.position[0]
        dy = goal_y - self.position[1]
        dist = math.hypot(dx, dy)
        angle_err = self.shortest_angle(math.atan2(dy, dx), self.yaw)
