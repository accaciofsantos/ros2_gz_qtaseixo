...
class UGVController(Node):
    ...
    def adrc_controller(self, dist, angle_err):
        ...
        r_ang = 8.0  # maior que r_lin, mas sem exagero
        beta1_ang = 3*r_ang
        beta2_ang = 3*r_ang**2
        beta3_ang = r_ang**3
        ...
        # ========================================
        # ESO – angular (corrigido)
        # ========================================
        # 1) erro angular correto (c/ wrap)
        e_w = self.shortest_angle(self.yaw, self.eso_ang_x1)

        # 2) atualização do ESO 3ª ordem consistente com yaw_dot = w + d
        ...
        # 3) normalizar estado angular (evita drift > pi)
        ...
        # Control law – angular
        # --------------------------
        # erro angular para o PD também normalizado
